...
# 회사 통일문구(PQR 작성방법) — 서술을 새로 지어내지 않고 정해진 문안을 그대로 씁니다.
# 14.1 은 일반 제품과 미국수출용 · 마약류의 문구가 다릅니다.
NO_HISTORY = {
    "11": "평가 년도 내 중요 일탈 및 기준 일탈 이력 없음.",
    "12": "품목허가(신고) 변경 관련 반려된 사항 검토 시, 특이사항 없음",
    "14": ("14.1 반품: 점검기간 내 사용기한 경과로 인한 반품 외 특이사항 없음\n"
           "14.2 불만: 평가 년도 내 불만 이력 없음.\n"
           "14.3 회수: 평가 년도 내 회수 이력 없음."),
    "15": "평가 년도 내 시정조치사항 이력 없음.",
}
# 미국수출용 · 마약류는 14.1 도 '이력 없음' 으로 씁니다.
NO_HISTORY_EXPORT = {
    "14": ("14.1 반품: 평가 년도 내 반품 이력 없음.\n"
           "14.2 불만: 평가 년도 내 불만 이력 없음.\n"
           "14.3 회수: 평가 년도 내 회수 이력 없음."),
}
CONCLUSION = (
